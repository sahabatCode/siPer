...
////Define Function
function bar128($text,$harga) {						// Part 1, make list of widths
  ...
  return "$html<tr><td hight=2 colspan=".strlen($w)." align=center font family=arial size=2 style='border-bottom:solid 1px #000;'><b>$text</td></tr><tr><td hight=2 colspan=".strlen($w)." align=left><font family=arial size=1>Rp.$harga</td></tr></table>";  
}